...
public class CacheKeyConstants {
     ...
     * 判断是否已经存在学位的key
     */
    public static final String TOPIC_COURSE_ACTIVITY_COURSE_EXIST = "topic_course_activity_course_exist:";


    public static String buildCheckExistKey(Long userId, Long activityId) {
        return TOPIC_COURSE_ACTIVITY_COURSE_EXIST + activityId + ":" + userId;
    }

    public static String buildGrabDegreeKey(Long activityId) {
        return DEGREE_NUM + activityId;
    }
